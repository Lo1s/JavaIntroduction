...
public class L1310_StillClock extends JPanel {
	/**
	 * 
	 */
	...
	public L1310_StillClock() {
		setCurrentTime();
	}

	/** Construct a clock with specified hour, minute, and second */
	public L1310_StillClock(int hour, int minute, int second) {
		this.hour = hour;
		this.minute = minute;
		this.second = second;
	}

	public L1310_StillClock(int hour, int minute, int second, boolean hourHand, boolean minuteHand, boolean secondHand) {
		this.hour = hour;
		this.minute = minute;
		this.second = second;
