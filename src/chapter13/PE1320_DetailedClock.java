 ...
 * 22:58:58
 */
public class PE1320_DetailedClock extends JFrame {
	...
	public PE1320_DetailedClock() {
		add(new DetailedClock(23, 10, 45));
	}
	
	public PE1320_DetailedClock(int hour, int minute, int second, boolean hourHand, boolean minuteHand, boolean secondHand) {
		add(new DetailedClock(hour, minute, second, hourHand, minuteHand, secondHand));
	}
	...
	public static void main(String[] args) {
		...
		JFrame frame = new PE1320_DetailedClock();
