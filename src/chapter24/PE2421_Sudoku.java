 ...
 */
public class PE2421_Sudoku extends Application {
	...
	public void start(Stage primaryStage) {
		...
		btDisplay.setPrefWidth(70);
		btRead.setPrefWidth(70);
		btRefresh.setPrefWidth(70);
		btSolve.setPrefWidth(70);
		btValid.setPrefWidth(70);
