...
/**
 * @author jslapnicka
 * @Date & @Time 20. 11. 2014 2014 16:53:46 
 */
@SuppressWarnings("serial")
public class PE2019_SierpinskiTriangle extends JApplet {
	...
	public PE2019_SierpinskiTriangle() {
		...
		jbtPlus.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				int order = trianglePanel.getOrder();
	...
	public static void main(String[] args) {
		...
		PE2019_SierpinskiTriangle applet = new PE2019_SierpinskiTriangle();
